...
This is a simple shell script written for automating the process of comparing a program's outputs with sample inputs and outputs. The script can be used to check the correctness of a program. 
